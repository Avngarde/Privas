...
namespace Privas.Interface
{
    ...
    {
        private static MongoClient Client => new("mongodb+srv://500PlusClient:Shaman2002$@cluster0.1kawz.azure.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
